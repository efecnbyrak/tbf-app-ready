...
export function KvkkContent({ variant = "page" }: KvkkContentProps) {
    const isModal = variant === "modal";

    return (
        <div className={isModal ? "" : "bg-white dark:bg-zinc-900 rounded-[2.5rem] shadow-xl border border-zinc-200 dark:border-zinc-800 overflow-hidden"}>
            {!isModal && (
            ...
            <div className={isModal ? "space-y-6 text-sm text-zinc-700 dark:text-zinc-300" : "p-8 md:p-12 space-y-8 text-sm text-zinc-700 dark:text-zinc-300"}>
