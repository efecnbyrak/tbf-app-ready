        ...
        <div className="min-h-screen flex flex-col bg-gradient-to-br from-red-700 to-zinc-950 text-white relative overflow-x-hidden">
            ...
            <main className="flex-1 flex flex-col items-center justify-center p-4 md:p-8 z-10 py-16 md:py-24">
                <div className="flex flex-col items-center text-center max-w-2xl w-full bg-black/20 backdrop-blur-md p-6 md:p-12 rounded-[2.5rem] border border-white/10 shadow-2xl animate-in fade-in zoom-in duration-500">
                    {/* Logo Container */}
                    <div className="bg-red-700/20 backdrop-blur-md p-8 rounded-[2.5rem] mb-12 shadow-2xl border border-white/10 transform hover:scale-105 transition-all duration-500">
                        <div className="w-24 h-24 md:w-32 md:h-32 bg-gradient-to-br from-red-500 to-red-800 rounded-3xl flex items-center justify-center text-4xl md:text-5xl font-black text-white shadow-inner">
                            BKS
                        </div>
                    </div>
                    ...
                    <p className="text-zinc-500 text-sm font-medium">© 2026 Basketbol Koordinasyon Sistemi - Tüm Hakları Saklıdır</p>
            ...
            <footer className="w-full p-8 flex items-center justify-center text-zinc-400 text-[10px] md:text-xs z-20 border-t border-white/5 bg-black/10 backdrop-blur-sm italic font-bold">
