...
export function ProfileSettings({ currentEmail, currentPhone }: ProfileSettingsProps) {
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-10 pr-3 py-2 border rounded-lg focus:ring-2 focus:ring-red-600 focus:border-transparent outline-none dark:bg-zinc-800 dark:border-zinc-700 dark:text-white"
