...
export function ProfileSettings({ currentEmail, currentPhone, currentAddress, currentIban, currentSecurityQuestion, currentSecurityAnswer }: ProfileSettingsProps) {
    ...
    const [securityAnswer, setSecurityAnswer] = useState(currentSecurityAnswer);
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-4">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="pt-4 border-t border-zinc-200 dark:border-zinc-800">
                                    <h4 className="text-sm font-bold text-red-600 mb-4 uppercase tracking-wider">Güvenlik Ayarları</h4>
                                    ...
                                    <div className="space-y-4">
                                        <div>
                                            ...
                                            <select
                                                ...
                                                className="w-full px-3 py-2 border border-zinc-300 dark:border-zinc-700 rounded-lg focus:ring-2 focus:ring-red-600 focus:border-transparent outline-none dark:bg-zinc-800 dark:text-white text-zinc-900 text-sm"
                                            >
                                                <option value="">Bir soru seçiniz...</option>
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[10px] text-zinc-500 mt-1 italic">
                                                * Şifrenizi unuttuğunuzda bu cevabı kullanacaksınız.
                                            </p>
                                        </div>
                                    </div>
                                </div>
