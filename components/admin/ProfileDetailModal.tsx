                    ...
                    <div className="lg:col-span-4 bg-zinc-50/80 dark:bg-zinc-950/40 p-10 lg:p-14 border-b lg:border-b-0 lg:border-r border-zinc-100/80 dark:border-zinc-800/80 flex flex-col items-center text-center">
                        <div className="flex flex-col items-center gap-4 mb-6">
                            <div className="relative group perspective-1000">
                                ...
                                {/* Admin can't remove photo as well */}
                                {(isSuperAdmin && official.imageUrl) && (
                                <button
                                    onClick={() => {
                        ...
                        <div className="w-full space-y-3">
                            ...
                            <div className="relative">
                                <button
                                    onClick={() => { if(isSuperAdmin) setEditingField(editingField === 'type' ? null : 'type') }}
                                    className={`w-full p-4 rounded-[1.5rem] flex flex-col items-center gap-1 transition-all ${isSuperAdmin ? 'hover:scale-[1.02] cursor-pointer' : 'cursor-default opacity-90'} border-2 ${editingField === 'type' ? 'bg-white dark:bg-zinc-800 border-red-50' : 'bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 border-transparent'}`}
                                >
                            ...
                            {editData.officialType === "REFEREE" && (
                                <div className="relative">
                                    <button
                                        onClick={() => { if(isSuperAdmin) setEditingField(editingField === 'class' ? null : 'class') }}
                                        className={`w-full p-4 rounded-[1.5rem] flex flex-col items-center gap-1 transition-all ${isSuperAdmin ? 'hover:shadow-xl cursor-pointer' : 'cursor-default opacity-90'} border-2 ${editingField === 'class' ? 'bg-white dark:bg-zinc-800 border-red-50 shadow-red-500/10' : 'bg-red-600 text-white border-transparent shadow-red-600/20'}`}
                                    >
                                    ...
                                    <div className="space-y-4">
                                        <div className="relative">
                                            <div className="flex flex-col">
                                                ...
                                                <button
                                                    onClick={() => { if(isSuperAdmin) setEditingField('region') }}
