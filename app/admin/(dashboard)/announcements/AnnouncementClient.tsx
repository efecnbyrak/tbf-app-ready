            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                        <label className="text-[10px] font-black text-zinc-400 uppercase tracking-widest italic ml-1">Alıcı Grubu</label>
                    ...
                    {/* Subject */}
                    <div className="space-y-2">
                        <label className="text-[10px] font-black text-zinc-400 uppercase tracking-widest italic ml-1">E-Posta Konusu</label>
                        <input
                            required
                            type="text"
                            value={subject}
                            ...
                            className="w-full bg-zinc-50 dark:bg-zinc-950 border border-zinc-100 dark:border-zinc-800 rounded-2xl py-3 px-4 text-sm font-bold focus:ring-2 focus:ring-red-500/20 focus:border-red-500 outline-none transition-all italic"
                        />
                    </div>
                </div>
                ...
                {/* Content */}
                <div className="space-y-2">
                    <label className="text-[10px] font-black text-zinc-400 uppercase tracking-widest italic ml-1">Duyuru İçeriği</label>
                    <textarea
                        required
                        value={content}
                        ...
                        rows={10}
                        className="w-full bg-zinc-50 dark:bg-zinc-950 border border-zinc-100 dark:border-zinc-800 rounded-3xl py-4 px-6 text-sm font-medium focus:ring-2 focus:ring-red-500/20 focus:border-red-500 outline-none transition-all italic resize-none"
                    />
                </div>
                ...
                <button
                    ...
                    type="submit"
                    className="w-full bg-red-600 hover:bg-zinc-900 text-white font-black py-4 rounded-2xl shadow-lg shadow-red-600/20 flex items-center justify-center gap-3 transition-all disabled:opacity-50 group hover:-translate-y-1"
                >
                    {loading ? (
