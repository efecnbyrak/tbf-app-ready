...
const ADMIN_HUB_CARDS: HubCard[] = [
    ...
    {
        title: "Uygunluk Formum",
        description: "Haftalık operasyon için kişisel uygunluk durumunuzu iletin.",
...
export default function AdminHub({ role }: { role?: string }) {
    const filteredCards = ADMIN_HUB_CARDS.filter(card => {
        if (card.title === "Profilim" && role === "SUPER_ADMIN") return false;
