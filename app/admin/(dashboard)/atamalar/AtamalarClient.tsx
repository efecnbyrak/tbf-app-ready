                        ...
                        {importResult ? (
                            ...
                            <>
                                <p className="text-zinc-500 text-sm mb-4">
                                    Google Drive'daki <strong>{season} Sezonu</strong> maç programlarını (tüm haftalar) sisteme aktarır.
                                    Sayfa her açıldığında güncel haftalar otomatik kontrol edilir; bu buton tüm sezonu yeniden tarar.
                                </p>
