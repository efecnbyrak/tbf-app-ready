...
export async function ensureSchemaColumns() {
    ...
    try {
        ...
        await db.$executeRawUnsafe(`ALTER TABLE users ADD COLUMN IF NOT EXISTS "forceRefresh" BOOLEAN NOT NULL DEFAULT false`);
        ...
        await db.$executeRawUnsafe(`ALTER TABLE users ADD COLUMN IF NOT EXISTS "pendingEmail" TEXT`);
        ...
        await db.$executeRawUnsafe(`ALTER TABLE referees ADD COLUMN IF NOT EXISTS "iban" TEXT`);

        // General Officials table (mapped as general_officials)
        await db.$executeRawUnsafe(`ALTER TABLE general_officials ADD COLUMN IF NOT EXISTS "address" TEXT`);
        await db.$executeRawUnsafe(`ALTER TABLE general_officials ADD COLUMN IF NOT EXISTS "job" TEXT`);
        await db.$executeRawUnsafe(`ALTER TABLE general_officials ADD COLUMN IF NOT EXISTS "points" INTEGER DEFAULT 0`);
        await db.$executeRawUnsafe(`ALTER TABLE general_officials ADD COLUMN IF NOT EXISTS "rating" INTEGER DEFAULT 0`);
        await db.$executeRawUnsafe(`ALTER TABLE general_officials ADD COLUMN IF NOT EXISTS "iban" TEXT`);
