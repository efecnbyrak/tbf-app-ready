...
export default function RefereeQuestionsPage() {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 py-8">
            <div className="mb-6 flex items-center justify-between">
                {step === 0 ? (
                    <Link href="/referee/bag" className="inline-flex items-center gap-2 text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-100 font-medium transition-colors">
                        <ChevronLeft className="w-4 h-4" /> Hakem Çantasına Dön
                    </Link>
                ) : (
                    <button onClick={() => {
                        if (step === 1) setStep(0);
