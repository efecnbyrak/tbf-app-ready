...
import { PlayCircle, Trophy, BookOpen, Briefcase, Sparkles, Bell } from "lucide-react";
...
export default function RefereeBagPage() {
    ...
    const sections = [
...

        {
            ...
            href: "/referee/questions",
            color: "border-amber-200 dark:border-amber-900/50 hover:border-amber-500",
            bg: "bg-amber-50 dark:bg-amber-900/10"
        },
        {
            title: "Kural Kitabı",
            description: "Basketbol oyun kuralları ve hakem mekaniği dokümanlarını inceleyin.",
                ...
                {sections.map((section, idx) => (
                    <Link key={idx} href={section.href} className="flex">
                        ...
                        `}>
                            ...
                            {/* Notification Badge for Assignments */}
