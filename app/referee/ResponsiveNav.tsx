...
import { User, Calendar, Menu, X, Sparkles, LayoutDashboard, Users, Briefcase, CheckCircle, Megaphone, Settings, ClipboardList, Shield, PlayCircle, Trophy, BookOpen } from "lucide-react";
...
export function ResponsiveNav({ refereeName, roleType, basePath = "/referee", titleOverride, isAdminObserver, imageUrl }: ResponsiveNavProps) {
                        ...
                        {isAdminObserver && (
                            <>
                                <div className="pt-6 pb-2 px-4 border-t border-zinc-100 dark:border-zinc-800 mt-4">
                                    <span className="text-[11px] font-black text-red-600 uppercase tracking-[0.2em] italic leading-none">Yönetim Merkezi</span>
                                </div>
                                <Link
                                    href="/admin"
                                    onClick={() => setIsOpen(false)}
