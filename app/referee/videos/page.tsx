    ...
    const fetchData = async () => {
        try {
            ...
            if (categoriesRes.ok) {
                ...
                setCategories(data);
                setExpandedCategories(new Set(data.map((c: VideoCategory) => c.id)));
            }
        } catch (err) {
                ...
                return (
                    ...
                    >
                        ...
                        <button
                            ...
                            className="w-full px-6 py-5 flex items-center justify-between hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors"
                        >
