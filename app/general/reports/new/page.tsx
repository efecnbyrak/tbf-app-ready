    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6">
            <div className="flex items-center gap-3">
                ...
                <div>
                    <h1 className="text-2xl font-black text-zinc-900 dark:text-white tracking-tight italic uppercase">GÖZLEMCİ RAPOR SİSTEMİ</h1>
                    <p className="text-xs font-bold text-zinc-500 uppercase tracking-widest italic leading-none">
