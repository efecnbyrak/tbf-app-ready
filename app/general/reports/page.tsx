...
export default async function MyReportsPage() {
    ...
    return (
        <div className="max-w-5xl mx-auto space-y-8">
            ...
            <div className="pt-4">
                <Link href="/general" className="inline-flex items-center gap-2 text-zinc-500 hover:text-red-600 font-black text-[10px] tracking-widest uppercase italic transition-colors">
